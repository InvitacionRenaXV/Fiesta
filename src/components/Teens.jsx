...
const TRASLADO_URL = 'http://uyturismo.com.uy';
function BusIcon() {
  return (
...
function ContactCard({ person, isMom }) {
  return (
    ...
    >
      <span className={styles.personIcon}>{isMom ? <PersonFemIcon /> : <PersonIcon />}</span>
      ...
      <div className={styles.inner}>
        ...
        <div className={styles.infoBlock}>
          <div className={styles.infoRow}>
            ...
            <p className={styles.infoText}>
              ...
              <a
                ...
                target="_blank"
                rel="noopener noreferrer"
                className={styles.plazaLink}
              >
                Plaza de Lezica
              </a>{' '}
              a las <strong>19:45 hs</strong> y estará a cargo de la empresa{' '}
              <a
                href={TRASLADO_URL}
                target="_blank"
                rel="noopener noreferrer"
          ...
          <div className={styles.infoRow}>
            ...
            <p className={styles.infoText}>
              {' '}
              El traslado de retorno hacia la plaza partirá a las <strong>4:00 am</strong> desde el
              salón.{' '}
            </p>
          </div>
        </div>
